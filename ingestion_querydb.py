...
os.environ["OPENAI_API_KEY"]="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" # Your Azure OpenAI resource key
...
engine = create_engine("mssql+pymssql://genaidb.database.windows.net:1433/DB_Demo1;trusted_Connection=yes;")
...
pyodbc.connect("Driver={ODBC Driver 18 for SQL Server};Server=tcp:genaidb.database.windows.net,1433;Database=DB_Demo1;Uid=378885@cognizant.com;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;Authentication=ActiveDirectoryIntegrated")
...
pg_uri = "mssql+pymssql://genaidb.database.windows.net:1433/DB_Demo1;Trusted_Connection=yes;"
...
db = pyodbc.connect('Driver={ODBC Driver 18 for SQL Server};Server=tcp:genaidb.database.windows.net,1433;Database=DB_Demo1;Uid={your_user_name};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;Authentication=ActiveDirectoryIntegrated'
    )
